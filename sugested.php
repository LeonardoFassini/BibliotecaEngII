   ...
   <div class="container col-md-10 col-xs-10 col-sm-10 col-md-offset-1 col-xs-offset-1 col-sm-offset-1" role="main">
      <div class="row">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> <a  href="sugestao.php"> Sugestões </a> </li>
        </ol>

        <div class="panel panel-default">
          <div class="panel-heading"> <h3> Inserido! </h3> </div>
          <div class="panel-body">
            <?php
                $res = pg_query($con, "insert into sugestao values('$_POST[sugestao]')");
              if($res) echo"Sua sugestão foi enviada!";
              else {
                echo "Não foi possível enviar sua sugestão";
              }
            ?>
