      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="nav">
            <ul class="nav navbar-nav">
              ...
              <li class="active"> <a href="devolucao.php"> Devolver Livro </a> </li>
   ...
   <div class="container col-md-10 col-xs-10 col-sm-10 col-md-offset-1 col-xs-offset-1 col-sm-offset-1" role="main">
      <div class="row">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> Devolver Livro </a> </li>
        </ol>

        <div class="panel panel-default">
           <div class="panel-heading"> <h3> Devolver Livro </h3> </div>
