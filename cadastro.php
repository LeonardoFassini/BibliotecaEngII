      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="nav">
            <ul class="nav navbar-nav">
              ...
              <li class="active"> <a href="cadastro.php"> Cadastrar Livro </a> </li>
   ...
   <div class="container col-md-10 col-xs-10 col-sm-10 col-md-offset-1 col-xs-offset-1 col-sm-offset-1" role="main">
      <div class="row">
        ...
        <div class="panel panel-default">
           <div class="panel-heading"> <h3> Cadastrar Livro </h3> </div>
           <div class="panel-body">
              <form class="form-horizontal" role="form" method="POST" action="cadastrado.php">
                 <div class="form-group">
                    <label for="nome" class="col-sm-4 col-xs-4 col-md-4 control-label"> Nome do livro: </label>
                    <div class="col-md-6">
                       <input id="nome" type="text" class="form-control" name="nome" placeholder="Nome" autofocus required>
                    </div>
                 </div>
                 <div class="form-group">
                    <label for="autor" class="col-sm-4 col-xs-4 col-md-4 control-label"> Autor: </label>
                    <div class="col-md-6">
                       <input id="autor" type="text" class="form-control" name="autor" placeholder="Autor" required>
                    </div>
                 </div>
                 <div class="form-group">
