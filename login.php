          ...
          <div class="panel-body">
            ...
            <form class="form-inline" role="form" action="" method="POST">
              <div class="form-group">
                <label for="username" class="col-sm-4 col-xs-4 col-md-4 control-label"> Login: </label>
                <input type="text" name="username" placeholder="LOGIN" id="username">
              </div>
              <div class="form-group">
                <label for="password" class="col-sm-4 col-xs-4 col-md-4 control-label"> Senha: </label>
                <input type="text" name="password" placeholder="SENHA" id="password">
              </div>
