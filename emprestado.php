      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="nav">
            <ul class="nav navbar-nav">
              ...
              <li class="active"> <a href="emprestimo.php" class="active"> Emprestar Livro </a> </li>
   ...
   <div class="container col-md-10 col-xs-10 col-sm-10 col-md-offset-1 col-xs-offset-1 col-sm-offset-1" role="main">
      <div class="row">
        ...
        <div class="panel panel-default">
           <div class="panel-heading"> <h3> Emprestar Livro </h3> </div>
           <div class="panel-body">
             <?php if($d == 1)echo"O livro foi emprestado com sucesso!"; ?>
           </div>
         </div>
        <!-- Content -->
