<?php $con = pg_connect("host=localhost user=postgres password=leonardo4774221  dbname=biblioteca") ?>
<?php session_start() ?>
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="nav">
            <ul class="nav navbar-nav">
              ...
              <li class="active"> <a href="sugestao.php"> Sugestão </a> </li>
   ...
   <div class="container col-md-10 col-xs-10 col-sm-10 col-md-offset-1 col-xs-offset-1 col-sm-offset-1" role="main">
      <div class="row">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> Sugestões </a> </li>
        </ol>

        <div class="panel panel-default">
           <div class="panel-heading"> <h3> Sugestões </h3> </div>
           <div class="panel-body">
              <form class="form-horizontal" role="form" method="POST" action="sugested.php">
                 <div class="form-group">
                    <label for="sugestao" class="col-sm-4 col-xs-4 col-md-4 control-label"> Sugestão: </label>
                    <div class="col-md-6">
                       <input id="sugestao" type="text" class="form-control" name="sugestao" placeholder="Eu sugiro..." required>
                    </div>
                 </div>
                 <div class="form-group">
